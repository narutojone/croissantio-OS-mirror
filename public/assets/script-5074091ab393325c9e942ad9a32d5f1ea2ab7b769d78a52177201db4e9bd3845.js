...
function populateDots() {
  $.each( $(".js--dots"), function(k, e) {
    var x = 0;
    var amount = $(e).data("amount")
    for (var i = 0; i < amount; i++) {
      $(e).append("<span style='top:" + x + "px' data-aos='zoom-in' class='hero-draft__dot'></span>")
      x+=13
    }
  })
}
...
function toggleBoxes() {
  $('.js--option').on('click', function() {
    ...
    $(".js--active-line").removeClass('active')
    $("div").find(`[data-id='${target}']`).addClass('active')
    $(this).children('.js--active-line').addClass('active')
  })
}
